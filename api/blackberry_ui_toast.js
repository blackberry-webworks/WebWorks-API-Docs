...
blackberry.ui.toast ={
         ...
         * @param {Number} [options.timeout] Optional timeout value that can be used to extend the toast for as long as the user desires. The value specified is parsed in milliseconds.
