...
* available: BlackBerry Push Service (for the general public) and the BlackBerry Enterprise Server (to enterprise users). The <code>PushService</code>
...
*    trace("Create was successful!");
*    // Use the pushService object to perform a launchApplicationOnPush, createChannel, destroyChannel, etc.
* }
*
* function failCallback(result) {
*    trace("Create failed with result code: " + result);
* }
*
