 ...
 *         // in order to access the shared folder, config.xml must declare the "access_shared" permsission
 *         fs.root.getFile(blackberry.io.sharedFolder + '/documents/log.txt', {}, function (fileEntry) {
