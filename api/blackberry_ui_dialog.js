...
blackberry.ui.dialog ={
         ...
         * @callback {Object} [onOptionSelected.selection] The object of the user's choice.
         * @callback {String} [onOptionSelected.selection.return] The element for the selected button, returns a string based on the user's choice. 
         * @callback {String} [onOptionSelected.selection.promptText] The element for entered text. Returns the user's entered string. If cancel is selected set to null. (This property is only used for select dialogs: D_PROMPT). <br/><br/>
